...
public class CategoryController {
    ...
    @ApiResponse(
            ...
            content = @Content(
                ...
                schema = @Schema(implementation = CategoryResponceDto.class)
            )
    )
    public CategoryResponceDto createCategory(@RequestBody @Valid CategoryRequestDto requestDto) {
        return categoryService.save(requestDto);
    }

    @Operation(summary = "Get all available categories with pagination")
    @GetMapping
    public List<CategoryResponceDto> getAllCategories(Pageable pageable) {
        return categoryService.findAll(pageable);
    }

    @GetMapping("/{id}")
    @Operation(summary = "Get category by id")
    public CategoryResponceDto getCategoryById(@PathVariable Long id) {
    ...
    public CategoryResponceDto updateCategoryById(@PathVariable Long id,
